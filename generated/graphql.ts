...
export type AboutRecord = {
  ...
  knowledges?: Maybe<Array<Maybe<SkillRecord>>>;
...
export type Query_AllProjectsMetaArgs = {
  locale?: Maybe<SiteLocale>;
  filter?: Maybe<ProjectModelFilter>;
};
...
export type QueryAllProjectsArgs = {
  ...
  first?: Maybe<Scalars['IntType']>;
  filter?: Maybe<ProjectModelFilter>;
  orderBy?: Maybe<Array<Maybe<ProjectModelOrderBy>>>;
};
...
export type AboutStaticPropsQuery = (
  ...
  & { about?: Maybe<(
    ...
    )>, knowledges?: Maybe<Array<Maybe<(
      { __typename?: 'SkillRecord' }
      & Pick<SkillRecord, 'title' | 'entries'>
    )>>> }
  )> }
);
...
export type WebsiteSeoTagsQuery = (
  ...
  & { about?: Maybe<(
    { __typename?: 'AboutRecord' }
    & Pick<AboutRecord, 'email' | 'socials'>
  )>, site: (
    { __typename?: 'Site' }
    & { favicon: Array<(
      { __typename?: 'Tag' }
